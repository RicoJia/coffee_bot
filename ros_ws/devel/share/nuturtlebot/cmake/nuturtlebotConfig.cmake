...
if("TRUE" STREQUAL "TRUE")
  set(nuturtlebot_SOURCE_PREFIX /home/ricojia/coffee_bot/ros_ws/src/default_coffeebot_pkgs/nuturtle)
...
if(NOT "/home/ricojia/coffee_bot/ros_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nuturtlebot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ricojia/coffee_bot/ros_ws/src/default_coffeebot_pkgs/nuturtle/${idir}'.  ${_report}")
    endif()
