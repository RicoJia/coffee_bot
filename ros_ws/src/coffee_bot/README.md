...
TODO: TO delete
3. read ticks, see how to get angular positions
4. publish wheel_cmd, add WheelVel msg type. 
5. In turtle_interface set up synchronous spinner, read the msg with time stamps, then Update the robot pose. 
6. Secondary goals
 - Test Timeout. 
 - Add destructor for modularized design - disable the motors. 
