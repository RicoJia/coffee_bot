...
Phidget_enumFromString(const char *name) {
	...
	if (mos_strcasecmp(name, "PHIDID_VINTMOIST") == 0)
		return (136);
	...
	if (mos_strcasecmp(name, "RTS_CTS_MODE_DISABLED") == 0)
		return (1);

	if (mos_strcasecmp(name, "RTS_CTS_MODE_REQUEST_TO_SEND") == 0)
		return (2);

	if (mos_strcasecmp(name, "RTS_CTS_MODE_READY_TO_RECEIVE") == 0)
		return (3);
...
Phidget_enumString(const char *family, int id) {
	...
	if (mos_strcasecmp(family, "RTS_CTS_Mode") == 0) {
		switch (id) {
		case 1:
...
supportedDeviceID(PhidgetChannelHandle ch, Phidget_DeviceID val) {
	...
	case PHIDCHUID_1024_DIGITALOUTPUT_5V_200:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1024:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_1024_DIGITALOUTPUT_LED_200:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1024:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_1024_DIGITALOUTPUT_ONBOARD_LED_200:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1024:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALINPUT_DSR_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALINPUT_DCD_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALINPUT_RI_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALOUTPUT_DTR_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_SERIAL_DIGITALINPUT_DSR_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_SERIAL:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_SERIAL_DIGITALOUTPUT_DTR_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_SERIAL:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_VINTMOIST_VOLTAGERATIOINPUT_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1067_1:
		case PHIDID_VINTMOIST:
			return (1);
		default:
			return (0);
		}
...
int
supportedRTS_CTS_Mode(PhidgetChannelHandle ch, PhidgetDataAdapter_RTSMode val) {

	switch (ch->UCD->uid) {
	case PHIDCHUID_ADP_RS232_DATAADAPTER_100:
		switch (val) {
		case RTS_CTS_MODE_DISABLED:
		case RTS_CTS_MODE_REQUEST_TO_SEND:
		case RTS_CTS_MODE_READY_TO_RECEIVE:
			return (1);
		default:
			return (0);
		}
